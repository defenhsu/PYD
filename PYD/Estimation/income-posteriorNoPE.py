'''
Bayesian estimation without PE terms (phi=0, h=0) scenario
Input files:
    estimation_top8_100plus.data (high schools enrolled 100+ students)
    income-parameterSetupNoPE.csv
Output files:
    income-posteriorNoPE.csv
...
def main():
    ...
    ## Parameter setup.
    theta_setup = pd.read_csv('priors/income-parameterSetupNoPE.csv')
